...
<head>
    ...
    <!-- Titles
    ================================================== -->
    <title>NSBM Accomedations</title>

    <!-- Favicons
    ================================================== -->
    <link rel="shortcut icon" href="assets/images/nsbm.png">
    ...
    <!-- ====== Header Top Area ====== -->
    <header style="background-color:#F6FFE9" class="header-area nevy-blue-bg hidden-xs hidden-sm">
        <div class="container">
            <div class="header-top-content">
                <div class="row">
                <div class="col-md-7 col-sm-7 mobile-center">
                    <div class="site-logo" style="position: relative; margin-bottom: 20px;">
                        <a href="index.php">
                            <img src="assets/images/nsbm.png" alt="site-logo" style="height: 100px; width: 300px;">
                        </a>
                    </div><!-- /.site-logo -->
                </div><!-- /.col-md-8 -->
                        ...
                        <div class="menu-wrapper">
                            <div class="menu-content">
                                <ul class="menu-list">
                                    ...
                                    <li>
                                        <a style="text-decoration:none;color:green" href="#"><?php echo $row['fullname']."  "; ?>
										   <?php if($row['photo']==""){ ?>
