...
<head>
	...
	<title>NSBM Accomedations Admin Panel</title>
...
<div class="main-header">
			<div class="logo-header">
				<a href="index.php" class="logo">
					<img style="width:110px;height:70px;background-color:transparent " src="../assets/images/nsbm.png" alt="House Rent Logo"/>
				</a>
			</div>
